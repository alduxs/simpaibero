                    ...
                    <table class="table table-custom table-centered table-select table-hover w-100 mb-0">
                        <thead class="bg-light align-middle bg-opacity-25 thead-sm">
                            <tr class="text-uppercase fs-xxs">
                                ...
                                <th data-table-sort="categoria">Categoría</th>
                                <th data-table-sort="galeria">Galería</th>
                                <th data-table-sort="posicion">Posición</th>
                                <th data-table-sort="hash">Hash</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $product->getCategoria->categoryName }}</td>
                                <td>{{ $product->getGallery->galleryName ?? 'Sin Galería'}}</td>
                                <td>{{ $product->productPosition }}</td>
                                <td>{{ $product->productHash }}</td>
                                <td>@if($product->productActiv == 1)<i class="ti ti-square-check-filled fs-xxl" style="color: green">@else <i class="ti ti-square fs-xxl"></i>@endif</td>
