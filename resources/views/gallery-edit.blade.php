                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Editar galería</h4>
                            </div>
                            ...
                            <div class="card-body">
                                <form action="/gallery/{{ $gallery->galleryId }}/update" method="post">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="galleryName" name="galleryName" value="{{ old('galleryName',$gallery->galleryName) }}">
                                        <input type="hidden" name="galleryId" value="{{ $gallery->galleryId  }}">
                                        @if ($errors->has('galleryName'))
                                            <div class="invalid-feedback" style="display: block">{{ $errors->first('galleryName') }}</div>
                                        @endif
                                    </div>
