...
<div class="container-fluid">
    ...
    <div class="page-title-head d-flex align-items-center">
        <div class="flex-grow-1">
            <h4 class="fs-sm text-uppercase fw-bold m-0">Textos</h4>
        </div>
            ...
            <div data-table data-table-rows-per-page="5" class="card">
                    ...
                    <table class="table table-custom table-centered table-select table-hover w-100 mb-0">
                        <thead class="bg-light align-middle bg-opacity-25 thead-sm">
                            <tr class="text-uppercase fs-xxs">
                                ...
                                <th data-table-sort="textName">Título</th>

                                <th data-table-sort="publicado">Publicado</th>

                                <th data-table-sort="nameActiv">Nombre Activo</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>@if($text->textActiv == 1)<i class="ti ti-square-check-filled fs-xxl" style="color: green">@else <i class="ti ti-square fs-xxl"></i>@endif</td>

                                <td>@if($text->nameActiv == 1)<i class="ti ti-square-check-filled fs-xxl" style="color: green">@else <i class="ti ti-square fs-xxl"></i>@endif</td>
                ...
                <div class="card-footer border-0">
                    <div class="d-flex justify-content-between align-items-center">
                        <div data-table-pagination-info="texts"></div>
